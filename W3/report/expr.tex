...
\codefig{terminal}{../CurvySyntax.hs}{87}{87}{Implementaiton of the terminal
  ``number''.}
...
\codefig{add}{../CurvySyntax.hs}{88}{88}{Implementation of the \texttt{+}
  operator.}
\codefig{mult}{../CurvySyntax.hs}{89}{89}{Implementation of the \texttt{*}
  operator.}

The above functions are bound together in the implementation of the parser
\texttt{expr} which is shown in \ref{code:expr}.

\codefig{expr}{../CurvySyntax.hs}{76}{89}{The final expression parser.}
